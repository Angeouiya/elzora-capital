...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card/96 text-card-foreground flex flex-col gap-4 rounded-2xl border border-border/80 py-5 shadow-[0_2px_4px_rgba(18,20,15,.025),0_16px_44px_rgba(56,12,49,.05)]",
        className
      )}
      {...props}
    />
