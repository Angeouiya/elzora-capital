...
const COPY = {
  fr: {
    ...
    updated: "Version du 22 septembre 2026",
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "4. Dette, actions et droits", body: "Une dette donne droit aux paiements contractuels sous réserve de la capacité de remboursement. Une action confère les droits prévus par les statuts, le pacte et la décision sociale concernée.", bullets: ["Aucune liquidité ou revente rapide n’est garantie", "Les droits de vote, dividendes et clauses de sortie varient par offre", "Les titres restent inscrits et administrés selon les actes sociaux applicables"] },
  ...
  en: {
    ...
    updated: "Version dated 22 September 2026",
