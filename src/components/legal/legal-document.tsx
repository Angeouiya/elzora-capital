  ...
  fr: {
    ...
    compliance: {
      ...
      sections: [
        ...
        { title: "BCEAO · paiements", body: "L’encaissement, le cantonnement et le versement doivent être confiés à des prestataires autorisés. La plateforme ne doit ni émettre de monnaie électronique ni détenir des fonds comme un établissement financier sans habilitation.", bullets: ["Carte, Mobile Money et virement via un partenaire ou un compte de collecte vérifié", "Réconciliation et traitement unique des confirmations de paiement", "Comptes de collecte séparés et bénéficiaires vérifiés"] },
        { title: "Limites internes de sécurité", body: "NEXORA applique ses propres limites préventives. Elles ne sont pas présentées comme des plafonds légaux universels : le prestataire, la banque ou l’émetteur Mobile Money peut imposer une limite plus basse.", bullets: ["Mobile Money : 1 000 000 FCFA par opération, 2 000 000 sur 24 h, 10 000 000 sur 30 jours, au plus 5 puis 20 opérations", "Carte : 10 000 000 FCFA par opération, 15 000 000 sur 24 h, 30 000 000 sur 30 jours, au plus 5 puis 20 opérations", "Virement : 50 000 000 FCFA par opération, 75 000 000 sur 24 h, 150 000 000 sur 30 jours, au plus 3 puis 10 opérations, avec examen systématique"] },
        { title: "LCB‑FT · connaissance client", body: "Le dispositif prévoit l’identification, l’origine des fonds, les personnes politiquement exposées, la surveillance des cumuls, de la fréquence, du fractionnement et l’escalade des alertes.", bullets: ["Examen renforcé à partir de 5 000 000 FCFA ou selon le profil, indépendamment du moyen choisi", "Décision finale par une seconde personne habilitée et autorisation limitée à 72 heures", "Conservation des preuves et signalements selon le cadre applicable, sans automatiser la décision de déclaration"] },
  ...
  en: {
    ...
    compliance: {
      ...
      sections: [
        ...
        { title: "BCEAO · payments", body: "Collection, safeguarding and payouts must be entrusted to authorized providers. The platform must not issue e-money or hold funds as a financial institution without authorization.", bullets: ["Card, Mobile Money and bank transfer through an authorized partner or verified collection account", "Reconciliation and single processing of payment confirmations", "Segregated collection and verified beneficiaries"] },
        { title: "Internal safety limits", body: "NEXORA applies preventive internal limits. They are not presented as universal legal caps: a provider, bank or Mobile Money issuer may impose a lower limit.", bullets: ["Mobile Money: XOF 1,000,000 per transaction, 2,000,000 over 24 hours and 10,000,000 over 30 days, with no more than 5 then 20 transactions", "Card: XOF 10,000,000 per transaction, 15,000,000 over 24 hours and 30,000,000 over 30 days, with no more than 5 then 20 transactions", "Bank transfer: XOF 50,000,000 per transaction, 75,000,000 over 24 hours and 150,000,000 over 30 days, with no more than 3 then 10 transactions and mandatory review"] },
        { title: "AML/CFT · customer due diligence", body: "The framework covers identification, source of funds, politically exposed persons, cumulative activity, velocity, structuring and alert escalation.", bullets: ["Enhanced review from XOF 5,000,000 or based on profile, regardless of the selected method", "A second authorized person makes the final decision and approval lasts no more than 72 hours", "Evidence retention and reporting under the applicable framework, without automating the reporting decision"] },
